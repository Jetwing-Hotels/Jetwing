  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      <div 
        ...
        onClick={onClose}
      ></div>
      <div className={`relative bg-white rounded-xl shadow-lg ${sizeClasses[size]} max-h-[90vh] overflow-y-auto`}>
        ...
        {footer && (
          <div className="p-6 border-t flex gap-3 justify-end" style={{ borderColor: '#E5E5E5' }}>
            {footer}
          </div>
        )}
      </div>
